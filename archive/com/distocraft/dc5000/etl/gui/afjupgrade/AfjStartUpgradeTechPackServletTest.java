 ...
 *
 */
public class AfjStartUpgradeTechPackServletTest {
  ...
  public void setUp() throws Exception {
    ...
    webmockRequest = new MockHttpServletRequest("POST", "/servlet/AfjStartUpgradeTechPack");
  ...
  /**
   * Test method for {@link com.distocraft.dc5000.etl.gui.afjupgrade.AfjStartUpgradeTechPackServlet#doHandleRequest(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, org.apache.velocity.context.Context)}.
   */
  @Test
  public void testDoHandleRequestBasic() {
    ...
    context.checking(new Expectations() {

      {
        ...
        allowing(mockAfjManagerProcess).upgradeAFJTechPackWithDelta();
    ...
    webmockSession.setAttribute(AfjStartUpgradeTechPackServlet.AFJ_MANAGER_PROCESS, mockAfjManagerProcess);
    
    final AfjStartUpgradeTechPackServlet servlet = new AfjStartUpgradeTechPackServlet();
    try {
  ...
  public void testDoHandleRequestWithInvalidProcess() {
    ...
    webmockSession.setAttribute(AfjStartUpgradeTechPackServlet.AFJ_MANAGER_PROCESS, null);
