 ...
 * 
 */
public class AfjStartUpgradeTechPackServlet extends EtlguiServlet {

  /**
   * 
   */
  private static final long serialVersionUID = 6278421167426633855L;
    ...
    try {
      ...
      if (amp == null) {
        ...
        if (amp.isRunning()) {
          ...
          log.info("Starting tech pack upgrade for " + amp.getSelectedTechPack().getTechPackName() + ".");
          amp.upgradeAFJTechPackWithDelta();
